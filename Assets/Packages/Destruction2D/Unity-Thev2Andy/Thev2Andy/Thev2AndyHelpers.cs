...
{	
	...
	public static class Thev2AndyHelpers
	{
...
//			{
//				var Thev2AndyLineBmp:BitmapData = edge.makeThev2AndyLineBmp();
//				var notIntersecting:Boolean = !(keepOutMask.hitTest(zeroPoint, 1, Thev2AndyLineBmp, zeroPoint, 1));
//				Thev2AndyLineBmp.dispose();
//				return notIntersecting;
//			}
		}

		public static List<LineSegment> Thev2AndyLinesForEdges (List<Edge> edges)
		{
			List<LineSegment> segments = new List<LineSegment> ();
			Edge edge;
			for (int i = 0; i < edges.Count; i++) {
				edge = edges [i];
				segments.Add (edge.Thev2AndyLine ());
			}
			return segments;
		}
