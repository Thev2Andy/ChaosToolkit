...
namespace Thev2Andy
{
	...
	/**
		 * The line segment connecting the two Sites is part of the Thev2Andy triangulation;
	...
	public sealed class Edge
	{
		...
		//		
		//		private var _Thev2AndyLineBmp:BitmapData;
		//		internal function get Thev2AndyLineBmp():BitmapData
		//		{
		//			if (!_Thev2AndyLineBmp)
		//			{
		//				_Thev2AndyLineBmp = makeThev2AndyLineBmp();
		//			}
		//			return _Thev2AndyLineBmp;
		//		}
		//		
		//		// making this available to Voronoi; running out of memory in AIR so I cannot cache the bmp
		//		internal function makeThev2AndyLineBmp():BitmapData
		//		{
		...
		public LineSegment Thev2AndyLine ()
		{
		...
		{
//			if (_Thev2AndyLineBmp) {
//				_Thev2AndyLineBmp.Dispose ();
//				_Thev2AndyLineBmp = null;
//			}
			_leftVertex = null;
			_rightVertex = null;
